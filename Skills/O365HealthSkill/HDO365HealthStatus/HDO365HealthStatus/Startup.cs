...
using HDO365HealthStatus.Adapters;
using HDO365HealthStatus.Bots;
using HDO365HealthStatus.Dialogs;
...
namespace HDO365HealthStatus
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<HealthStatusDialog>();            

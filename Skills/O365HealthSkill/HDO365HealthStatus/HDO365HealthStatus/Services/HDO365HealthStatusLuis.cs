...
namespace Luis
{
    public partial class Hdo365HealthStatusLuis: IRecognizerConvert
    {
        [JsonProperty("text")]
        public string Text;
        ...
        public class _Entities
        {
            ...
            {
                public InstanceData[] IncidentDetail;
            }
        ...
        {
            var app = JsonConvert.DeserializeObject<Hdo365HealthStatusLuis>(

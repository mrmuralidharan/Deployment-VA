...
namespace Luis
{
    public partial class AcronymLookupLuis: IRecognizerConvert
    {
        [JsonProperty("text")]
        public string Text;
        ...
        public class _Entities
        {
            ...
            {
                public InstanceData[] Acronym;
                public InstanceData[] Description;
                public InstanceData[] Operation;
            }
        ...
        {
            var app = JsonConvert.DeserializeObject<AcronymLookupLuis>(

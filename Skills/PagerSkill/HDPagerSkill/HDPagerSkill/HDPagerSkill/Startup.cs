...
using HDPagerSkill.Adapters;
using HDPagerSkill.Bots;
using HDPagerSkill.Dialogs;
...
namespace HDPagerSkill
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<PagerCreateIncidentDiaolog>(); 
            services.AddTransient<PagerEscalationPolicyDiaolog>();
            services.AddTransient<PagerPolicyMembersDiaolog>();
            services.AddTransient<TestDiaolog>();
            // Configure adapters

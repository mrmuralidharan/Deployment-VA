...
Param(
    ...
    [string] $luisAuthoringKey = "c17d0e50074e4379ad699b5a2329863d",
	[string] $luisAccountName = "HDHelpSkill-luisprediction-hyitjyt",
    [string] $luisAccountRegion ="eastus",
	[string] $luisSubscriptionKey,
    [string] $luisEndpoint ="https://hospitalityskill-luisauthoring-3vi6j6r.cognitiveservices.azure.com/",
	[string] $resourceGroup ="HD-Homer-Dev1",

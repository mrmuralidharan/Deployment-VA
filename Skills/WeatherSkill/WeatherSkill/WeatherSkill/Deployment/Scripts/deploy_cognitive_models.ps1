...
Param(
	[string] $name="WeatherSkill",
	[string] $luisAuthoringRegion="westus",
    [string] $luisAuthoringKey="f1fa493e832145bca2f3a28ae087d23b",
	[string] $luisAccountName="WeatherSkill-luisruntime-7xcyzii",
    [string] $luisAccountRegion="eastus",
	[string] $luisSubscriptionKey="387fceedc1794dc0a10f516b162c6f12",
    [string] $luisEndpoint="https://weatherskill-luisauthoring-7xcyzii.cognitiveservices.azure.com/",
	[string] $resourceGroup="HD-Homer",

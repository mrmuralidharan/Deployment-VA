...
namespace WeatherSkill.Dialogs
{
    public class MainDialog : ComponentDialog
    {
            ...
            : base(nameof(MainDialog))
        {
            ...
            AddDialog(serviceProvider.GetService<TodayWeatherDialog>() ?? throw new ArgumentNullException(nameof(TodayWeatherDialog)));
        }
        ...
        [Obsolete("This is for interrupt")]
            ...
            if (activity.Type == ActivityTypes.Message && !string.IsNullOrEmpty(activity.Text))
            {
                ...
                switch (intent)
                {
                    case WeatherSkillLuis.Intent.CheckWeatherValue:
                        {
                            return await stepContext.BeginDialogAsync(nameof(TodayWeatherDialog), cancellationToken: cancellationToken);
                        }

                    case WeatherSkillLuis.Intent.ForecastWeather:
                        {
